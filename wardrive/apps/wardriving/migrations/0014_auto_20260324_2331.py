...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("wardriving", "0013_wardriving_wardriving_up_mac_ch_alv"),
    ]
    ...
    operations = [
        django_db_views.operations.ViewRunPython(
            ...
            reverse_code=django_db_views.migration_functions.BackwardViewMigration(
                "", "wardriving_vendor", engine="django.db.backends.postgresql"
            ),
            atomic=False,
        ),
        django_db_views.operations.ViewRunPython(
            ...
            reverse_code=django_db_views.migration_functions.BackwardViewMigration(
                "", "wardriving_vendor", engine="django.db.backends.sqlite3"
            ),
            atomic=False,
        ),
        django_db_views.operations.ViewRunPython(
            ...
            reverse_code=django_db_views.migration_functions.BackwardViewMigration(
                "", "wardriving_vendor", engine="django.db.backends.mysql"
            ),
            atomic=False,
        ),
    ]
